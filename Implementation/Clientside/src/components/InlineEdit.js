 ...
 * !Important
 *
 * InlineEdit component from https://www.npmjs.com/package/react-edit-inline.
 * Can't be in the node modules because default behavior had to be changed (doubleClick instead of click).
 */
        ...
        value: function render() {
            if (this.props.isDisabled) {
                ...
                return _react2.default.createElement(Element, {
                    onDoubleClick: this.clickWhenEditing,
